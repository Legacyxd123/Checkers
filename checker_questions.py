...
class Checker(TwoPlayerGame):
    ...
    def make_move(self, pos):
        ...
        pieces_index = self.get_piece_pos_from_table() 
        
        self.board[pieces_index,] = self.current_player
    ...
    def lose(self):
        ...
        #Create Answer to hold W/L Bool
        answer = []
    ...
    def is_over(self):
        ...
        return self.lose() or (self.possible_moves() == 0)
